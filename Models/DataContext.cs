    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Kategori>().HasData(
            new List<Kategori> {
                ...
                new Kategori {Id=6, KategoriAdi="kategori 1a", Url="kategori-1"},
                new Kategori {Id=7, KategoriAdi="kategori 2a", Url="kategori-2"},
                new Kategori {Id=8, KategoriAdi="kategori 3a", Url="kategori-3"},
                new Kategori {Id=9, KategoriAdi="kategori 4a", Url="kategori-4"},
                new Kategori {Id=10, KategoriAdi="kategori 5a", Url="kategori-5"},
            }
        );
